CREAT DATABASE GamesDB;

CREATE TABLE Customer (ID INT AUTO_INCREMENT, Name VARCHAR(32) NOT NULL, Email VARCHAR(64), Address VARCHAR(64) NOT NULL, PRIMARY KEY(ID));
